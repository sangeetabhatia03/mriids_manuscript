...
params:
  ...
  nsamples: 1000
  centroids: data/processed/all_african_centroids.csv
  N: 55
---
...
daily_projections <- lapply(index, function(row){
                                     ...
                                     flowmat  <-
                                         matrix(NA,
                                                length(centroids$country),
                                                length(centroids$country))
                                     rownames(flowmat) <- centroids$country
                                     colnames(flowmat) <- centroids$country
                                     ## fill in the matrix from the vectors
                                     flow_from_to <- mRIIDS:::flow_vector(n_from,
                                                                          n_to,
                                                                          distvec,
                                                                          model = "gravity",
                                                                          mobility)
                                     ...
                                     flow_to_from <- mRIIDS:::flow_vector(n_to,
                                                                          n_from,
                                                                          distvec,
                                                                          model = "gravity",
                                                                          mobility)
