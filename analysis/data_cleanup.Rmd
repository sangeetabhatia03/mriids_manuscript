...
params:
  ...
  outfile: 27062019_promed_loglinear
...
purrr::map(countries, function(c) {
  ...
  p <- ggpubr::ggarrange(plotlist = cspecific, nrow = 3, ncol = 2, labels = "auto", align = "hv", font.label = list(size = 6))
  ggplot2::ggsave(
    plot = p,
    filename = here::here(
      glue::glue("analysis/figures/{params$outfile}_{c}.pdf")
    ),
    width = mriids_plot_theme$single_col_width,
    height = mriids_plot_theme$single_col_height,
