...
## Outfile 1: sensitivity_specificity_tproj_n.dates.sim.csv
## Outfile 2: alerts_per_week_twindow_n.dates.sim.csv
source(
    here::here(
...
source(here::here("analysis/forecasts_metrics_consolidate.R"))
