...
```{r who-hm-promed-comparison-3, echo = FALSE}
...
#coeffs <- purrr::map_dfr(coeffs, broom::tidy, .id = "country_tw")
...
## WHO vs ProMED
p_who_pm <- ggplot(r_who_pm) + mriids_plot_theme$theme
...
p_all <- ggpubr::ggarrange(p_who_pm,
  p_who_hm,
  p_pm_hm,
  nrow = 1,
  ncol = 3,
