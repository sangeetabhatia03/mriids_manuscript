...
params:
  ...
  twindow : 14
  incid : data/processed/01032019_who_bycountry_weekly.csv
  n.dates.sim : 28
  place: GIN
  maxtproj: 413
...
## Also save as RDS file for later manipulation.
outfile <- stringr::str_replace(outfile, ".png", ".rds")
readr::write_rds(x = pall,
                 path = outfile)
```
