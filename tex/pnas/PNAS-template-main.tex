...
achieved high sensitivity but variable specificity. In general, using higher
...
high specificity (98.0\%) but poor sensitivity in predicting presence
of cases in weeks following a week with no observed cases in each
...
is raised \ref{fig:tprbythreshold}.} The cut-off for raising an alert can thus be chosen based
