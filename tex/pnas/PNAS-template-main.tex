...
no observed cases. For instance, in May 2014, the model \sangeeta{correctly predicted} the
...
\item
  ...
  different case numbers. In such cases, we assigned the median of the case numbers
  to the record.}
\item
