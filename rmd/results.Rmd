...
and HealthMap in Sierra Leone, see `r si_tab_nums("rcorr", display = "c")`).
...
Supplementary Information (SI) (sections 
...
ProMED data, and forecasting ahead for 4 weeks, 49% of observed 
incidence across all three countries in the forecast horizon 
were included in the 95% forecast interval.  Using data from 
Healthmap and WHO respectively, this figure was 62.75% and 73.5%.
...
(`r pm_model_perf_all_windows`) suggest that overall, the 
...
from any other country currently affecred. The risk of importation is
...
weighted by the infectivity at the source (see Methods). Estimates of
the risk of importation could be particularly valuable in the
early phase of an outbreak to guide policy. Our estimates
...
instance,  in May 2014,
the risk of importation into Sierra Leone is concentrated in Guinea 
(`r imp_risk_cite`). 
